...
你好，我是 Alex 🎯，你的数字助手。有活儿尽管吩咐，没活儿也可以唠唠嗑。
```
...
This is a real-world onboarding scenario that inspired this skill:

1. **Application**: User provided Feishu App ID and Secret
2. **Registration**: Added to agents.list, channels.feishu.accounts, and bindings
3. **Workspace**: Created workspace directory with all core files
4. **Skills**: Assigned relevant skills based on agent's role
